	...
	/**
	 * \brief Carga los datos de los empleados desde el archivo data.csv a la memoria. (El traslado de datos es en modo texto).
	 * \param path char* La ruta del archivo que indica donde se abre.
	 * \param pArrayListEmployee LinkedList* Lista de empleados.
	 * \return int Retorna 0 si se logro cargar 1 o mas empleados. Si no un numero menor a 0.
	 */
	...
	/**
	 * \brief Carga los datos de los empleados desde el archivo data.bin a la memoria. (El traslado de datos es en modo binario).
	 * \param path char* La ruta del archivo que indica donde se abre.
	 * \param pArrayListEmployee LinkedList* Lista de empleados.
	 * \return int Retorna 0 si se logro cargar 1 o mas empleados. Si no un numero menor a 0.
	 */
	 ...
	 * \param pArrayListEmployee LinkedList* Lista de empleados.
	 * \return int Retorna 0 si la modificacion del empleado salio bien. Sino un numero menor a 0.
	 */
	 ...
	 * \return int Retorna 0 si la eliminacion del empleado salio bien. Sino un numero menor a 0.
	 */
	 ...
	 * \param pArrayListEmployee LinkedList* Lista de empleados.
	 * \return int Retorna 0 si el ordenamiento salio bien. Si no un numero menor a 0.
	 */
	...
	/**
	 * \brief Guarda los datos de los empleados desde la memoria hasta el archivo "data.csv". (El traslado de datos es en modo texto).
	 * \param path char* La ruta del archivo que indica donde se abre.
	 * \param pArrayListEmployee LinkedList* Lista de empleados.
	 * \return int Retorna 0 si se logro guardar 1 o mas empleados. Si no un numero menor a 0.
	 */
	...
	/**
	 * \brief Guarda los datos de los empleados desde la memoria hasta el archivo "data.bin". (El traslado de datos es en modo binario).
	 * \param path char* La ruta del archivo que indica donde se abre.
	 * \param pArrayListEmployee LinkedList* Lista de empleados.
	 * \return int Retorna 0 si se logro guardar 1 o mas empleados. Si no un numero menor a 0.
	 */
	...
	/**
	 * \brief Busca (recorriendo ll) y reemplaza el maximo id. Recibe un puntero al id del main para poder reemplazar su valor si encuentra un nuevo valor de id maximo.
	 * \param idValorMinimoRecibido int* El puntero al valor que tiene que id en el momento que se llama a la funcion.
	 * \param pArrayListEmployee LinkedList* Lista de empleados.
	 * \return int Retorna 0 si se llego se reemplazo el valor maximo del id aun asi si es el mismo numero. Si no un numero menor a 0.
	 */
	...
	/**
	 * \brief Realiza las ultima acciones (limpia ll y luego la elimina).
	 * \param pArrayListEmployee LinkedList* Lista de empleados.
	 * \return int Retorna 0 si la limpieza y el borrado de la linkedlist se pudo realizar. Si no un numero menor a 0.
	 */
