	...
	/*
	 * \brief Pide memoria necesaria para el sizeof de un empleado.
	 ...
	 * \param idEmpleado int valor id del empleado.
	 ...
	 * \param this Employee* Direccion de memoria recibida de tipo empleado.
	 */
	 ...
	 * \param this Employee* Puntero recibido al empleado donde se obtiene.
	 * \param id char* Puntero al Id donde se va a guardar el id obtenido.
	 * \return int Retorna 0 si la validacion y la obtencion salio bien.
	 */
	...
	/*
	 * \brief Recibe las horas trabajadas del empleado, la verifica y si es valido las setea en el puntero a empleado.
	 * \param this Employee* Puntero recibido al empleado donde se settea.
	 * \param horasTrabajadas int Valor de horas recibidas para setearlas en el empleado.
	 * \return int Retorna 0 si la validacion y el setteo salio bien.
	 */
	...
	/*
	 * \brief Recibe las horas trabajadas como texto, lo verifica y si es valido lo convierte y lo setea en el puntero recibido.
	 * \param this Employee* Puntero recibido al empleado donde se settea.
	 * \param horasTrabajadas char* Horas trabajadas recibidas en forma de texto.
	 * \return int Retorna 0 si la validacion, la conversion y el setteo salio bien.
	 */
	...
	/*
	 * \brief Recibe un valor de sueldo y lo setea en un puntero a empleado.
	 * \param this Employee* Puntero recibido al empleado donde se settea.
	 * \param sueldo int Valor del sueldo recibido.
	 * \return int Retorna 0 si la validacion y el setteo salio bien.
	 */
	...
	/*
	 * \brief Recibe un sueldo como caracter, lo convierte, lo valida y lo settea en un puntero a empleado.
	 * \param this Employee* Puntero recibido al empleado donde se settea.
	 * \param sueldo char* Sueldo recibido en forma de caracteres.
	 * \return int Retorna 0 si la validacion, la conversion y el setteo salio bien.
	 */
	...
	/*
	 * \brief Obtiene el sueldo de un puntero al empleado.
	 * \param this Employee* Puntero recibido al empleado donde se settea.
	 * \param suledo int* Puntero al sueldo donde se va a guardar el que se obtenga del empleado.
	 * \return int Retorna 0 si la validacion de lo obtenido salio bien.
	 */
	...
	/*
	 * \brief Obtiene todos los parametros de un empleado y valida cada uno de ellos.
	 * \param this Employee* Puntero al empleado del cual se van a obtener los campos.
	 * \param id int* Puntero al id donde se va a guardar el id obtenido y validado.
	 * \param nombre char* Puntero al nombre donde se va a guardar el nombre obtenido y validado.
	 * \param horasTrabajadas int* Puntero a la variable donde se van a guardar las horas trabajdas obtenidas y validadas.
	 * \param sueldo int* Puntero al sueldo donde se va a guardar el sueldo opbtenido y validado.
	 * \return int Retorna 0 si se obtuvo y se valido correctamente cada campo.
	 */
	...
	/*
	 * \brief Valida, convierte a int los que se puedan y settea en un empleado todos los campos recibidos.
	 * \param this Employee* Puntero recibido al empleado donde se settea.
	 * \param id char* Id recibido como caracter del cual se va a validar, convertir a int y setear en el empleado.
	 * \param nombre char* Nombre recibido del cual se va a validar y setear en el empleado.
	 * \param horasTrabajadas char* Horas trabajadas recibida como caracter del cual se va a validar, convertir a int y setear en el empleado.
	 * \param sueldo char* Sueldo recibido como caracter del cual se va a validar, convertir a int y setear en el empleado.
	 * \return int Retorna 0 si todos los campos aprobaron la validacion y el setteo al empleado salio bien.
	 */
	...
	/*
	 * \brief Valida y settea en un empleado todos los campos recibidos.
	 * \param this Employee* Puntero recibido al empleado donde se settea.
	 * \param id int Id recibido el cual se va a validar y setear en el empleado.
	 * \param nombre char* Nombre recibido del cual se va a validar y setear en el empleado.
	 * \param horasTrabajadas int Horas trabajadas recibidas la cual se va a validar y setear en el empleado.
	 * \param sueldo int Sueldo recibido el cual se se va a validar y setear en el empleado.
	 * \return int Retorna 0 si todos los campos aprobaron la validacion y el setteo al empleado salio bien.
	 */
	 ...
	 * \param this Employee* Puntero recibido al empleado donde se obtiene el nombre.
	 * \param nombre char* Puntero donde se va a guardar el nombre obtenido si es validado.
	 * \return int Retorna 0 si la obtencion y la validacion del nombre salio bien.
	 */
	...
	/*
	 * \brief Recibe el puntero a un empleado y lo imprime.
	 * \param this Employee* Puntero recibido al empleado el cual se imprime
	 * \return int Retorna 0 si la validacion y el setteo salio bien.
	 */
	...
	/*
	 * \brief Obtiene todos los campos de un empleado y los valida.(Excepto el id).(La obtencion es desde la consola)
